...
const handleClick = () => {
  ...
  return (
	...
	<div className="bg-desktop">
		<svg id="bg-desktop-one" height="200px" width="200px" filter="blur(100px)" xmlns="http://www.w3.org/2000/svg">
