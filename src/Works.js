	  ...
	  <>
		<Swiper
		  ...
		  breakpoints={{
	    	...
	    	id="sliderProject" className="swiper mySwiper">
			...
			<a href="/">Choose<br />Right</a> help users make a choice <br />from a variety of options.
			</h3>
			...
			<SwiperSlide className="swiper-slide" id="mark-it">
				...
				<h4 className="project-categoryIMG">Art Direction</h4>
  				...
  				<h3 className="project-description"><svg className="twoProject-SVGone" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 25 41" fill="none">
	  			<path stroke="url(#a)" strokeLinecap="round" strokeLinejoin="round" d="M3.595 6.808C.395 13.608.5 16 3 21.5S12.5 47 16.5 41c1.664-2.496 4.158-8.28 5.595-12.692 2.905-8.917 2.012-17.808 0-21.5-3.712-6.808-14.5-8.5-18.5 0Z"/><path stroke="var(--lightred)" strokeLinecap="round" strokeLinejoin="round" d="M19.309 23.237c-3.844 3.694-10.085 1.026-13.816-2.886C1.52 16.183.688 9.385 4.293 5.921c3.603-3.463 10.21-1.731 13.815 1.155 3.604 2.886 6.006 11.544 1.201 16.161Z"/>
				</svg>
				Concept of an innovative <br /><strong>AR-application</strong> - Mark it.<br />Creating an ecosystem <br />in augmented reality.<br />
  			</h3>
</SwiperSlide>
			<SwiperSlide className="swiper-slide" id="promrating">
  			...
  			<h3 className="project-description"><svg className="threeProject-SVGone" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 50 22" fill="none">
	  			<path stroke="url(#a)" strokeLinecap="round" strokeLinejoin="round" d="M20.443 16.102c-.548 1.383-1.167 2.684-1.722 3.798-2.818 5.663-20 5.766-17.977-8.592C2.362-.179 10.364.377 14.161 2.09c9.544 1.345 8.516 8.366 6.282 14.012Zm0 0c8.691 2.403 23 4.96 28.557 11.398"/>
				</svg>
				Redesign of <strong>the research agency</strong>.<br /> There was no corporate identity<br />for the agency. The task is to create<br />a <strong>fresh</strong> and <strong>serious website</strong>.
  			</h3>
</SwiperSlide>
			<SwiperSlide className="swiper-slide" id="Bubble">
				<video width="100%" autoPlay loop muted>
					<source src={bubbleWeb} type="video/mp4" />
				</video>
				<h4 className="project-categoryIMG">Art Direction</h4>
  			<h4 className="project-category">Art Direction</h4>
  			<h3 className="project-description"><svg className="fourProject-SVGone" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 52 27" fill="none"><path stroke="url(#a)" strokeLinecap="round" strokeLinejoin="round" d="M1 13C1-2.207 16-.5 24.5 7 27.333 5.167 35.79-2.321 44 2c9.5 5 8 15 1.5 19-6.762 4.161-16 1-21-2C18.5 30 1 28 1 13Z"/>
  			</svg>
  			<svg className="fourProject-SVGtwo" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 42 37" fill="none"><path stroke="url(#a)" strokeLinecap="round" strokeLinejoin="round" d="M32 .5c0 2.4-7.333 8-11 10.5-3.2 2.338-10.667-2.693-14-5.5.5 2.667 2.6 9.2 3 14 .4 4.8-6.5 9-9.5 10.5 2.667-.5 8.5-1.5 10.5-1.5s4.167 5 5 7.5c2.5-3.167 7.8-9.1 9-7.5 1.5 2 13.5 5 13.5 2.5S34 27 34 23.5c0-2.8 4.667-8.667 7.5-10-3.5.167-9.5 2.4-9.5 0V.5Z"/></svg>
				Online store for a <strong>comic book</strong><br />publisher. Featuring the creation <br />of <strong>3D characters</strong> and inter-<br />universe crossovers.
  			</h3>
  </SwiperSlide>
		</Swiper>
	</>
