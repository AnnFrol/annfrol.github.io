    ...
    <>
      ...
      >
        <SwiperSlide className="swiper-slide active" id="choose-right">
          ...
          <h4 className="project-categoryIMG">APP Design, Development</h4>
          <h4 className="project-category">APP Design, Development</h4>
        ...
        <SwiperSlide className="swiper-slide" id="mark-it">
          ...
          <h4 className="project-categoryIMG">Art Direction</h4>
          <h4 className="project-category">Art Direction</h4>
          <h3 className="project-description">
            <svg
        ...
        <SwiperSlide className="swiper-slide" id="promrating">
          ...
          <h4 className="project-categoryIMG">WEB Design, Micromotion</h4>
          <h4 className="project-category">WEB Design, Micromotion</h4>
          <h3 className="project-description">
            <svg
